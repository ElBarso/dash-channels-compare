...
def load_files(input_path, file_extension):
    ...
    # Iteratively search along the passed path for files with the desired extension
...
def webapp_creator(measures, tagToColor_dict):
    ...
    # Create empty lists, one for each data channel and
    # fill it with dcc graph objects of loaded curves
    ch1 = []
    ch2 = []
    ch3 = []
    ch4 = []
        ...
        html.Div([
            html.Div([
                dcc.Graph(id='ch1',
                          figure={
                              'data': ch1,
                              'layout': go.Layout(title='Channel 1', hovermode='closest')
            ...
            html.Div([
                dcc.Graph(id='ch2',
                          figure={
                              'data': ch2,
                              'layout': go.Layout(title='Channel 2', hovermode='closest')
                          #})], style={'width': '50%', 'height': 200, 'display': 'inline-block'})
                          })], style={'display': 'inline-block'})
            ], style={'height': 400}),
        ...
        html.Div([
            html.Div([
                dcc.Graph(id='ch3',
                          figure={
                              'data': ch3,
                              'layout': go.Layout(title='Channel 3', hovermode='closest')
                          #})], style={'width': '50%', 'height': 200, 'display': 'inline-block'}),
                          })], style={'display': 'inline-block'}),
            html.Div([
                dcc.Graph(id='ch4',
                          figure={
                              'data': ch4,
                              'layout': go.Layout(title='Channel 4', hovermode='closest')
                          #})], style={'width': '50%', 'height': 200, 'display': 'inline-block'}),
                          })], style={'display': 'inline-block'})
            ], style={'height': 400}),
        ...
        html.Div([
            ...
            html.Div([
                dcc.Graph(id='selected-graph',
                          ...
                          )], style={'width': 850, 'display': 'inline-block'})
            ], style={'display': 'inline-block'})
    ...
    def update_graph_comparison(hoverData):
        # pPint(hoverData1) # return a list containing dictionaries
        ...
        figure = {'data':[go.Scatter(x=x_ch1,
                  ...
                  'layout': go.Layout(title='Updated Curve comparison')
                  }
        return figure
...
if __name__ == '__main__':
    ...
    file_extension = ".mat"
    #input_path = r"C:\Users\Utente\Downloads\2022-01-24"
    input_path = r"C:\Users\Jonathan\Downloads\BeadsData\2022-01-24"
